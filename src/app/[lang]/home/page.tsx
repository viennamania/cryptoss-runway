                                  ...
                                  {item.status === 'cancelled' ? (
                                    ...
                                    <button
                                      ...
                                      onClick={() => {
                                        ...
                                        //window.open(`https://stable.makeup/${params.lang}/${"admin"}/sell-usdt/${item._id}`, '_blank');

                                        // copy to clipboard

                                        navigator.clipboard.writeText(`https://stable.makeup/${params.lang}/${"admin"}/sell-usdt/${item._id}`);
...
const UserPaymentPage = (
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center gap-4">
      ...
      {/* iframe */}
      <iframe
        src={`https://stable.makeup/kr/${selectedItem?.storecode}/pay-usdt-reverse/${selectedItem?._id}`}
